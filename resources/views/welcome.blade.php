...
<section class="our-services">
    <div class="container">
        <img src="{{asset('assets/img/services.jpg')}}" class="service-img')}}" alt="Our Services" title="Our Services">
...
<section class="overline">
    <div class="container">
        ...
        <img src="{{asset('assets/img/insurance-policies.jpg')}}'" alt="Insurance Policies" title="Insurance policies" class="insurance-policies">
...
<section class="about">
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <img src="{{asset('assets/img/about-img.jpg')}}" alt="About Insurancy" title="About Insurancy" class="about-img">
            </div>
        </div>
        ...
        <div class="partners">
            <div class="row">
                ...
                <div class="col partners-grid">
                    <img src="{{asset('assets/img/partner-1.png')}}" alt="Partner" title="Partner" class="partner-img">
                    <img src="{{asset('assets/img/partner-2.png')}}" alt="Partner" title="Partner" class="partner-img">
                    <img src="{{asset('assets/img/partner-3.png')}}" alt="Partner" title="Partner" class="partner-img">
                    <img src="{{asset('assets/img/partner-4.png')}}" alt="Partner" title="Partner" class="partner-img">
                    <img src="{{asset('assets/img/partner-5.png')}}" alt="Partner" title="Partner" class="partner-img">
                    <img src="{{asset('assets/img/partner-6.png')}}" alt="Partner" title="Partner" class="partner-img">
                </div>
            </div>
        </div>
    </div>
...
<section class="testimonial">
    <div class="container">
        ...
        <div class="testimonial-profile">
            <img src="{{asset('assets/img/client.jpg')}}" alt="Client" title="Client" class="profile-img">
            <span>
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="lead-form agent-card">
                    <img src="{{asset('assets/img/agent.jpg')}}" alt="Agent" title="Agent" class="agent-img">
                    ...
                    <h6 class="agent-email">
                        <ion-icon name="mail-unread-outline"></ion-icon> jason@insurancy.com
                    </h6>
                </div>
            </div>
        </div>
